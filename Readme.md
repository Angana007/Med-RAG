...
LLM Inference:       ComponentTechnologyLLM InferenceOllama (Phi-3 Mini)
...
To ensure the clinical assistant runs correctly, follow these steps:
...
pip install langchain-huggingface beautifulsoup4 ollama

2. Download and Install Ollama

Verify installation: ollama --version

3. Pull the Local Model: ollama pull phi3

4. Data Initialization: Run the ingestion scripts to build the database and vector store
...
This will populate the SQLite Database and create the FAISS index.

5. Start the API: Launch the FastAPI server
